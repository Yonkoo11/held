...
- Video decision: silent with on-screen titles from DEMO-SCRIPT.md's [SUB] lines, Held tokens (paper #faf8f4, ink #17150f, accent #b0431c, Fraunces / Spline Sans / Spline Sans Mono). Building with Skill(demo-video).
...
- full table in PROOF.md, regenerated by `npm run prove`
